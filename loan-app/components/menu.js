  ...
  return (
    <div className={styles.navbar}>
      <Menu as="div" className={styles.dropdown}>
        <div>
          <Menu.Button className={styles.dropBttn}>Category</Menu.Button>
        </div>
        <Menu.Items>
      ...
      <Menu as="div" className={styles.dropdown}>
        <div>
          <Menu.Button className={styles.dropBttn}>Specs</Menu.Button>
        </div>
        <Menu.Items>
          <div className={styles.dropdownContent}>
            <Menu.Item>
      ...
      <Menu as="div" className={styles.dropdown}>
        <div>
          <Menu.Button className={styles.dropBttn}>Equipment</Menu.Button>
        </div>
        <Menu.Items>
          <div className={styles.dropdownContent}>
            <Menu.Item>
      ...
      <Menu as="div" className={styles.dropdown}>
        <div>
          <Menu.Button className={styles.dropBttn}>Users</Menu.Button>
        </div>
        <Menu.Items>
          <div className={styles.dropdownContent}>
            <Menu.Item>
      ...
      <Menu as="div" className={styles.dropdown}>
        <div>
          <Menu.Button className={styles.dropBttn}>Loan</Menu.Button>
        </div>
        <Menu.Items>
          <div className={styles.dropdownContent}>
            <Menu.Item>
